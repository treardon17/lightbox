...
gulp.task('browser-sync', ['sass', 'pug', 'js', 'images', 'php-forms', 'php', 'php-serve'], ()=>{
    browserSync.init({
...
gulp.task('browser-sync-html', ['sass', 'pug', 'js', 'images', 'php-forms', 'php'], ()=>{
    browserSync.init({
        server: {
...
gulp.task('watch',()=>{
    ...
    gulp.watch(paths.dev.root + '**/*.pug', ['pug', 'php']).on('change', ()=>{browserSync.reload()});
    ...
    gulp.watch(paths.dev.root + '**/*.php', ['php']).on('change', ()=>{browserSync.reload()});
});

//Build and compile everything
gulp.task('build', ['sass', 'pug', 'js', 'images', 'php-forms', 'php']);
